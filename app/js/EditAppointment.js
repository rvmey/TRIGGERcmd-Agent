...
var EditAppointment = /*#__PURE__*/function (_React$Component) {
  function EditAppointment(props) {
    ...
    _this = _callSuper(this, EditAppointment, [props]);
    _this.handleTriggerChange = _this.handleTriggerChange.bind(_this);
    _this.handleCommandChange = _this.handleCommandChange.bind(_this);
    _this.handleOffCommandChange = _this.handleOffCommandChange.bind(_this);
    _this.handleGroundChange = _this.handleGroundChange.bind(_this);
    _this.handleVoiceChange = _this.handleVoiceChange.bind(_this);
    _this.handleVoiceReplyChange = _this.handleVoiceReplyChange.bind(_this);
    ...
    _this.voiceReplyInstructions = _this.voiceReplyInstructions.bind(_this);
    _this.handleEdit = _this.handleEdit.bind(_this);
    return _this;
  }
  _inherits(EditAppointment, _React$Component);
  return _createClass(EditAppointment, [{
    ...
    key: "voiceReplyInstructions",
    value: function voiceReplyInstructions(e) {
    ...
    key: "handleQuoteParamsChange",
    value: function handleQuoteParamsChange(e) {
      this.props.onQuoteParamsChange(e.target.value);
    }
  }, {
    key: "handleMcpToolDescriptionChange",
    value: function handleMcpToolDescriptionChange(e) {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: "col-sm-3 control-label",
        htmlFor: "voiceReply"
      }, t('Voice/MCP Reply')), /*#__PURE__*/React.createElement("div", {
        className: "col-sm-9"
      }, /*#__PURE__*/React.createElement("input", {
        type: "text",
        className: "form-control",
        ...
        placeholder: t('The old Alexa skills and MCP will say this back (optional)'),
        onChange: this.handleVoiceReplyChange,
        value: voiceReplyvalue
      }), /*#__PURE__*/React.createElement("button", {
        type: "button",
        className: "btn btn-link",
        onClick: this.voiceReplyInstructions
      }, t('How to use Voice/MCP Reply field')))), /*#__PURE__*/React.createElement("div", {
        className: "form-group"
      }, /*#__PURE__*/React.createElement("label", {
        className: "col-sm-3 control-label",
        htmlFor: "mcpToolDescription"
      }, t('MCP Tool Description')), /*#__PURE__*/React.createElement("div", {
        className: "col-sm-9"
      }, /*#__PURE__*/React.createElement("input", {
        type: "text",
        className: "form-control",
        ...
        ref: function ref(_ref8) {
          return _this2.inputMcpToolDescription = _ref8;
        },
        placeholder: t('How AI should use this command and parameters (optional)'),
        onChange: this.handleMcpToolDescriptionChange,
        ...
        ref: function ref(_ref9) {
          return _this2.inputAllowParams = _ref9;
        },
        ...
        className: "col-sm-3 control-label",
        htmlFor: "quoteParams"
      }, t('Quote Parameters')), /*#__PURE__*/React.createElement("div", {
        className: "col-sm-9"
      }, /*#__PURE__*/React.createElement("select", {
        className: "form-control",
        id: "quoteParams",
        ref: function ref(_ref0) {
          return _this2.inputQuoteParams = _ref0;
        },
        onChange: this.handleQuoteParamsChange,
        value: quoteParamsvalue
      }, /*#__PURE__*/React.createElement("option", null, "false"), /*#__PURE__*/React.createElement("option", null, "true")))), /*#__PURE__*/React.createElement("div", {
        className: "form-group"
      }, /*#__PURE__*/React.createElement("label", {
        className: "col-sm-3 control-label"
...
},{"./EmojiPicker":34,"react":31,"react-i18next":22}],34:[function(require,module,exports){
"use strict";
