...
class AddAppointment extends React.Component {
  ...
  render() {
    ...
    if (this.props.operatingSystem == 'darwin') {
      groundOptions = React.createElement("select", {id: "mySelect", className: "form-control", id: "aptDate", ref: (ref) => this.inputAptDate = ref, onChange: this.handleGroundChange}, 
          ...
          React.createElement("div", {className: "modal-content"}, 
            ...
            React.createElement("form", {className: "modal-body add-appointment form-horizontal", onSubmit: this.handleAdd}, 
              React.createElement("div", {className: "form-group"}, 
                ...
                React.createElement("div", {className: "col-sm-9"}, 
                  React.createElement("input", {type: "text", className: "form-control", 
                    id: "petName", ref: (ref) => this.inputPetName = ref, placeholder: "Trigger name", onChange: this.handleTriggerChange, required: true})
                )
              ), 
              React.createElement("div", {className: "form-group"}, 
                ...
                React.createElement("div", {className: "col-sm-9"}, 
                  React.createElement("input", {type: "text", className: "form-control", 
                    id: "petOwner", ref: (ref) => this.inputPetOwner = ref, placeholder: "Your command", onChange: this.handleCommandChange, required: true})
                )
              ), 
              React.createElement("div", {className: "form-group"}, 
                React.createElement("label", {className: "col-sm-3 control-label", htmlFor: "offCommand"}, "Off Command"), 
                React.createElement("div", {className: "col-sm-9"}, 
                  React.createElement("input", {type: "text", className: "form-control", disabled: disableOffCommandField, 
              ...
              React.createElement("div", {className: "form-group"}, 
                ...
                React.createElement("div", {className: "col-sm-9"}, 
                  React.createElement("select", {id: "mySelect", className: "form-control", id: "allowParams", ref: (ref) => this.inputAllowParams = ref, onChange: this.handleAllowParamsChange}, 
